        ...
        >
          <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
            ...
            <p className="text-black-500 mt-4 mb-6">
              We are a growing and professional international pharmaceutical
          ...
          {listUser.map((listUsers, index) => (
            ...
            >
              <div className="flex mx-auto w-40 sm:w-auto">
                <div className="flex items-center justify-center bg-background w-12 h-12 mr-6 rounded-full">
                  <img src={listUsers.icon} className="h-6 w-6 bg-green" />
                </div>
